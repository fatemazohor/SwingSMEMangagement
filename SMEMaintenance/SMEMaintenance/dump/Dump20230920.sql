...
INSERT INTO `demo_table` VALUES (1,'Rakib',25,NULL),(2,'Akib',25,NULL);
...
CREATE TABLE `product_stock` (
  ...
  KEY `idproducts_idx` (`product_id`),
  CONSTRAINT `idproducts` FOREIGN KEY (`product_id`) REFERENCES `products` (`idproducts`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `products` VALUES (1,'demoproduct',100,10,5,'2023-09-20'),(3,'demopro3',200,100,5,'2023-09-20'),(4,'demo4',2,46,10,'2023-09-20');
...
-- Dump completed on 2023-09-20 13:10:56
